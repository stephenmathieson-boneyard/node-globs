 ...
 */
declare function G(pattern: string|string[], cb?: (err: Error | null, matches: string[]) => void): Promise<T>;
 ...
 * @param [cb] The callback invoked when the search completes.
 */
declare function G(pattern: string|string[], options: glob.IOptions, cb?: (err: Error | null, matches: string[]) => void): Promise<T>;
